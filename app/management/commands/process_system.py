...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Processed {processed_rt} recurring transactions."))
        ...
        self.stdout.write(self.style.SUCCESS("System processing finished successfully!"))
